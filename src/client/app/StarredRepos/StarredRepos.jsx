...
const forkStyle = {color: "#808080", fontSize: "14px"};
  ...
  render() {
    return (
      ...
      <Row className="show-grid">
        <Col xs={6} xsOffset={3}>
          <h1 className={style.pStyle}>Starred repos for axiomatic design</h1>
        </Col>
              ...
              <Card key={repo.id}>
                ...
                <CardText>
                  ...
                  <div >
                    ...
                    <a style={forkStyle} href= {repo.stargazers_url}>{repo.stargazers_count}</a>
                    {'  \u00A0 '}
                    <FontAwesome name='code-fork' />
                    <a style={forkStyle} href= {repo.forks_url}>{repo.forks_count}</a>
                  </div>
                </CardText>
              </Card>
              <br/>
